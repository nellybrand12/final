...
const INITIAL_SERVICES = [
  ...
  },
  {
    ...
    descriptionFr:
      "Profitez d’un mélange de cuisine africaine et internationale préparée avec des saveurs riches et authentiques, disponible sur place ou livrée directement dans votre chambre.",
    descriptionEn:
  ...
  },
  {
    ...
    descriptionFr:
      "Une salle de sport bien équipée pour la musculation et le fitness quotidien, ouverte à tous nos clients désirant rester actifs durant leur séjour.",
    descriptionEn:
  ...
  },
  {
    ...
    descriptionFr:
      "Louez un véhicule avec ou sans chauffeur privé pour des visites personnalisées de la ville et des déplacements en toute commodité.",
    descriptionEn:
    ...
    ctaLink: "https://wa.me/237691890963",
    order: 4,
  },
  {
    id: "event-halls",
    ...
    descriptionFr:
      "Salles polyvalentes pour réceptions, réunions et autres rencontres, modulables pour s’adapter à des événements de toute envergure.",
    descriptionEn:
  ...
  },
  {
    ...
    descriptionFr:
      "Des soins de massage relaxants conçus pour vous aider à vous détendre et à vous ressourcer durant votre séjour.",
    descriptionEn:
