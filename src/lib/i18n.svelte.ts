...
const translations = {
  fr: {
    ...
    hero: {
      ...
      showcaseSubtitle: "L'idéal pour votre plaisir — Rue Naomi Eto, Etoug Ebe",
    ...
    showcase: {
      ...
      upTo: "Jusqu’à",
      guests: "personnes",
      venueBadge: "Salle Événementielle",
      perSeat: "FCFA / place",
      upToAttendees: "Jusqu'à {n} convives",
    },
    ...
    reserve: {
      ...
      filterAll: "Tous",
      filterRooms: "Chambres",
      filterApartments: "Appartements",
      filterHalls: "Salles",
      badgeHall: "Salle d'Événement",
      badgeApartment: "Appartement",
      badgeRoom: "Chambre",
      capacitySeats: "Capacité {n} places",
      maxGuests: "Max {n} pers.",
      eventTypeLabel: "Type d'Événement",
      eventTypePlaceholder: "Ex: Mariage, Conférence...",
      attendeesCountLabel: "Nombre de participants (places)",
      maxSeats: "Max {n} places",
      billingAddressLabel: "Adresse de facturation (Optionnel)",
      billingAddressPlaceholder: "Ex: Bastos, Yaoundé",
      cityLabel: "Ville (Optionnel)",
      cityPlaceholder: "Ex: Yaoundé",
      cinetpayPreparing: "Préparation du paiement sécurisé CinetPay...",
      retryPayment: "Réessayer avec CinetPay",
      payHotelHeader: "Règlement à la réception",
      hallCancellationTitle: "Conditions d’annulation de la salle :",
      hallCancellationNotice: "En confirmant cette réservation, vous acceptez nos conditions générales. Les annulations effectuées au moins 36 heures avant l’événement bénéficient d’un remboursement garanti de 95%.",
      accommodationCancellationTitle: "Conditions d’annulation de l’hébergement :",
      accommodationCancellationNotice: "En confirmant cette réservation, vous acceptez nos conditions générales. Les annulations effectuées au moins 20 heures avant l’arrivée (check-in) bénéficient d’un remboursement garanti de 95%.",
      eventStart: "Début événement",
      eventEnd: "Fin événement",
      ...
      seatUnit: "places",
      venueConfigError: "Tarif par place ou capacité non configuré pour cette salle.",
      attendeesMinError: "Veuillez saisir un nombre de participants valide (au moins 1).",
      attendeesExceedError: "Le nombre de participants ne peut pas dépasser la capacité maximale ({n} places).",
    },
    // Confirmation Page
    confirmation: {
    ...
    rooms: {
      ...
      hallsCat: "Salles d'Événements",
      capacityHalls20: "20+ pers. (Salles)",
      capacityHalls50: "50+ pers. (Grandes salles)",
    ...
    roomDetails: {
      ...
      exploreOther: "Découvrez également nos autres logements",
      practicalInfo: "Informations Pratiques",
      earlyCheckIn: "À partir de 14h00 (Arrivée anticipée sur demande)",
      lateCheckOut: "Jusqu’à 12h00 (Départ tardif selon disponibilité)",
      breakfastLabel: "Petit-déjeuner :",
      breakfastDesc: "Servi de 06h30 à 10h30 au restaurant ou en appartement",
      cancellationLabel: "Annulation :",
      cancellationDesc: "Gratuite jusqu’à 48h avant la date d’arrivée",
      ...
      artOfLiving: "L'Art de Vivre Madadjeu",
      artOfLivingDesc: "Conçue pour garantir une intimité absolue, cette demeure met à votre disposition des équipements technologiques de pointe, une insonorisation acoustique optimale et un service d’étage sur mesure face à la Garde Présidentielle.",
      attendeesCount: "Nombre de participants (places)",
      maxCapacitySeats: "Max {n} places",
    },
    // Amenities Page
    amenities: {
      metaTitle:
  ...
  en: {
    ...
    hero: {
      ...
      showcaseSubtitle: "Ideal for your pleasure — Rue Naomi Eto, Etoug Ebe",
    ...
    showcase: {
      ...
      perSeat: "FCFA / seat",
      upToAttendees: "Up to {n} attendees",
    },
    // Prime Geographical Location — Neighborhood Carousel (100vw)
    neighborhoods: {
    ...
    reserve: {
      ...
      filterHalls: "Halls",
      badgeHall: "Event Hall",
      badgeApartment: "Apartment",
      badgeRoom: "Room",
      capacitySeats: "Capacity {n} seats",
      maxGuests: "Max {n} guests",
      eventTypeLabel: "Event Type",
      eventTypePlaceholder: "e.g. Wedding, Conference...",
      attendeesCountLabel: "Number of participants (seats)",
      maxSeats: "Max {n} seats",
      billingAddressLabel: "Billing Address (Optional)",
      billingAddressPlaceholder: "e.g. Bastos, Yaounde",
      cityLabel: "City (Optional)",
      cityPlaceholder: "e.g. Yaounde",
      cinetpayPreparing: "Preparing secure CinetPay payment...",
      retryPayment: "Retry with CinetPay",
      payHotelHeader: "Payment at Front Desk",
      hallCancellationTitle: "Event Hall Cancellation Policy:",
      hallCancellationNotice: "By confirming this booking, you accept our general terms. Cancellations made at least 36 hours before the event receive a guaranteed 95% refund.",
      accommodationCancellationTitle: "Accommodation Cancellation Policy:",
      accommodationCancellationNotice: "By confirming this booking, you accept our general terms. Cancellations made at least 20 hours before arrival (check-in) receive a guaranteed 95% refund.",
      ...
      seatUnit: "seats",
      venueConfigError: "Price per seat or capacity not configured for this venue.",
      attendeesMinError: "Please enter a valid attendee count (at least 1).",
      attendeesExceedError: "Attendee count cannot exceed capacity ({n} seats).",
    },
    // Confirmation Page
    confirmation: {
    ...
    rooms: {
      ...
      hallsCat: "Event Halls",
      capacityHalls20: "20+ guests (Halls)",
      capacityHalls50: "50+ guests (Grand Halls)",
    ...
    roomDetails: {
      ...
      exploreOther: "Explore Our Other Accommodations",
      practicalInfo: "Practical Information",
      earlyCheckIn: "From 2:00 PM (Early check-in upon request)",
      lateCheckOut: "Until 12:00 PM (Late check-out subject to availability)",
      breakfastLabel: "Breakfast:",
      breakfastDesc: "Served from 6:30 AM to 10:30 AM in restaurant or room",
      cancellationLabel: "Cancellation:",
      cancellationDesc: "Free up to 48 hours before arrival date",
      ...
      panoramic: "Panoramic",
      equipment: "Equipment",
      artOfLiving: "The Madadjeu Art of Living",
      artOfLivingDesc: "Conceived to guarantee supreme privacy, this residence offers cutting-edge amenities, high-grade acoustic insulation, and tailored in-room service opposite the Presidential Guard.",
      attendeesCount: "Number of participants (seats)",
      maxCapacitySeats: "Max {n} seats",
    },
    // Amenities Page
    amenities: {
      metaTitle:
