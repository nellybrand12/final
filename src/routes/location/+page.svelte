  ...
  <div class="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-16">
    ...
    <div class="text-center max-w-3xl mx-auto mb-16 md:mb-20">
      <div class="inline-flex items-center gap-3 mb-4">
        <span class="w-8 h-[1px] bg-muted-gold dark:bg-muted-gold-dark"></span>
        <span class="font-label-caps text-muted-gold dark:text-muted-gold-dark tracking-[0.25em] text-xs uppercase">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mb-20">
      ...
      <div class="lg:col-span-6 space-y-5">
        <div class="border-b border-outline-variant/30 dark:border-neutral-800 pb-3 flex items-center justify-between">
          <div>
            ...
            <span class="text-[10px] font-label-caps text-muted-gold dark:text-muted-gold-dark tracking-widest mt-1 block">
      ...
      <div class="lg:col-span-6 lg:sticky lg:top-28 space-y-4">
        ...
        <div class="bg-surface-container-lowest dark:bg-neutral-900 border border-outline-variant/35 dark:border-neutral-800 p-6 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div class="space-y-1">
            <span class="font-label-caps text-[10px] text-muted-gold dark:text-muted-gold-dark tracking-widest uppercase block">
