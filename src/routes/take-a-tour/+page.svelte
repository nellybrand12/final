...
<div class="w-full bg-surface py-12 md:py-24">
  <div class="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-16">
      ...
      {#each locations as location, index}
        ...
        >
          ...
          <div class="w-full md:w-1/2">
            ...
            >
              <div
                class="relative aspect-[4/3] rounded-2xl overflow-hidden bg-deep-charcoal shadow-lg border border-outline-variant/30"
              >
                <img
                ...
                <div class="absolute top-4 left-4 bg-deep-charcoal/80 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/15 pointer-events-none">
                  <span class="font-mono text-xs text-muted-gold font-bold tracking-wider">
                    {location.num}
                  </span>
                </div>
              </div>
          ...
          <div class="w-full md:w-1/2 flex flex-col items-start gap-3.5 md:gap-4">
            ...
            <!-- Title -->
            <h2 class="font-headline text-lg sm:text-2xl lg:text-2xl text-deep-charcoal font-normal leading-snug">
              {location.title}
            </h2>
            ...
            <div class="pt-1 flex flex-wrap gap-1.5">
              {#each location.highlights as highlight}
                <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-surface-container border border-outline-variant/30 text-[11px] text-on-surface font-medium">
    ...
    <!-- ================= 3. BOTTOM CTA BANNER ================= -->
    <div class="mt-20 md:mt-28 p-6 md:p-12 bg-deep-charcoal text-soft-cream relative overflow-hidden shadow-2xl border border-white/10">
